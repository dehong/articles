# Table of Contents
  ...
  * [synchronized](#synchronized)
    ...
    * [synchronized的三种应用方式](#synchronized的三种应用方式)
      * [synchronized作用于实例方法](#synchronized作用于实例方法)
      * [synchronized作用于静态方法](#synchronized作用于静态方法)
      * [synchronized同步代码块](#synchronized同步代码块)
    * [synchronized底层语义原理](#synchronized底层语义原理)
      * [理解Java对象头与Monitor](#理解java对象头与monitor)
      * [synchronized代码块底层原理](#synchronized代码块底层原理)
      * [synchronized方法底层原理](#synchronized方法底层原理)
      * [Java虚拟机对synchronized的优化](#java虚拟机对synchronized的优化)
        * [偏向锁](#偏向锁)
        * [轻量级锁](#轻量级锁)
        * [自旋锁](#自旋锁)
        * [锁消除](#锁消除)
    * [关于synchronized 可能需要了解的关键点](#关于synchronized-可能需要了解的关键点)
      * [synchronized的可重入性](#synchronized的可重入性)
      * [线程中断与synchronized](#线程中断与synchronized)
        * [线程中断](#线程中断)
...
![image-20180729162745721](https://github.com/dehong/articles/blob/master/java/多线程/assets/image-20180729162745721.png)
...
![image-20180729163157242](https://github.com/dehong/articles/blob/master/java/多线程/assets/image-20180729163157242.png)
...
![image-20180729163318039](https://github.com/dehong/articles/blob/master/java/多线程/assets/image-20180729163318039.png)
